    ...
    <tables>
      ...
      <table cardinality="oto" sqlname="awardContractID">
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='awardID']/*[namespace-uri()=$ns1 and local-name()='awardContractID']/*[namespace-uri()=$ns1 and local-name()='agencyID']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='awardID']/*[namespace-uri()=$ns1 and local-name()='awardContractID']/*[namespace-uri()=$ns1 and local-name()='PIID']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='awardID']/*[namespace-uri()=$ns1 and local-name()='awardContractID']/*[namespace-uri()=$ns1 and local-name()='modNumber']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='awardID']/*[namespace-uri()=$ns1 and local-name()='awardContractID']/*[namespace-uri()=$ns1 and local-name()='transactionNumber']"/>
      ...
      <table cardinality="oto" sqlname="IDVID">
        <column>
          ...
          <xsl:attribute name="sqlname">agencyID</xsl:attribute>
          <xsl:attribute name="datatype">CHARACTER(4)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractID']/*[namespace-uri()=$ns1 and local-name()='IDVID']/*[namespace-uri()=$ns1 and local-name()='agencyID']"/>
        ...
        <column>
          ...
          <xsl:attribute name="sqlname">PIID</xsl:attribute>
          <xsl:attribute name="datatype">VARCHAR(50)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractID']/*[namespace-uri()=$ns1 and local-name()='IDVID']/*[namespace-uri()=$ns1 and local-name()='PIID']"/>
        ...
        <column>
          ...
          <xsl:attribute name="sqlname">modNumber</xsl:attribute>
          <xsl:attribute name="datatype">VARCHAR(25)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractID']/*[namespace-uri()=$ns1 and local-name()='IDVID']/*[namespace-uri()=$ns1 and local-name()='modNumber']"/>
      ...
      <table cardinality="oto" sqlname="referencedIDVID">
        <column>
          ...
          <xsl:attribute name="sqlname">agencyID</xsl:attribute>
          <xsl:attribute name="datatype">CHARACTER(4)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and (local-name()='awardID' or local-name='contractID')]/*[namespace-uri()=$ns1 and local-name()='referencedIDVID']/*[namespace-uri()=$ns1 and local-name()='agencyID']"/>
        ...
        <column>
          ...
          <xsl:attribute name="sqlname">PIID</xsl:attribute>
          <xsl:attribute name="datatype">VARCHAR(50)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and (local-name()='awardID' or local-name='contractID')]/*[namespace-uri()=$ns1 and local-name()='referencedIDVID']/*[namespace-uri()=$ns1 and local-name()='PIID']"/>
        ...
        <column>
          ...
          <xsl:attribute name="sqlname">modNumber</xsl:attribute>
          <xsl:attribute name="datatype">VARCHAR(25)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and (local-name()='awardID' or local-name='contractID')]/*[namespace-uri()=$ns1 and local-name()='referencedIDVID']/*[namespace-uri()=$ns1 and local-name()='modNumber']"/>
      ...
      <table cardinality="oto" sqlname="solicitationID">
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(25)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='solicitationID']"/>
      ...
      <table cardinality="oto" sqlname="dates">
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='relevantContractDates']/*[namespace-uri()=$ns1 and local-name()='signedDate']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">DATE</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='relevantContractDates']/*[namespace-uri()=$ns1 and local-name()='effectiveDate']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">DATE</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='relevantContractDates']/*[namespace-uri()=$ns1 and local-name()='currentCompletionDate']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">DATE</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='relevantContractDates']/*[namespace-uri()=$ns1 and local-name()='ultimateCompletionDate']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">DATE</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='relevantContractDates']/*[namespace-uri()=$ns1 and local-name()='lastDateToOrder']"/>
      ...
      <table cardinality="oto" sqlname="dollarValues">
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='dollarValues']/*[namespace-uri()=$ns1 and local-name()='baseAndAllOptionsValue']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">NUMERIC</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='dollarValues']/*[namespace-uri()=$ns1 and local-name()='baseAndExercisedOptionsValue']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">NUMERIC</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='dollarValues']/*[namespace-uri()=$ns1 and local-name()='obligatedAmount']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">NUMERIC</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='totalDollarValues']/*[namespace-uri()=$ns1 and local-name()='totalBaseAndAllOptionsValue']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">NUMERIC</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='totalDollarValues']/*[namespace-uri()=$ns1 and local-name()='totalBaseAndExercisedOptionsValue']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">NUMERIC</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='totalDollarValues']/*[namespace-uri()=$ns1 and local-name()='totalObligatedAmount']"/>
      ...
      <table cardinality="oto" sqlname="purchaserInformation">
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(4)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='purchaserInformation']/*[namespace-uri()=$ns1 and local-name()='contractingOfficeAgencyID']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='purchaserInformation']/*[namespace-uri()=$ns1 and local-name()='contractingOfficeID']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(4)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='purchaserInformation']/*[namespace-uri()=$ns1 and local-name()='fundingRequestingAgencyID']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(6)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='purchaserInformation']/*[namespace-uri()=$ns1 and local-name()='fundingRequestingOfficeID']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='purchaserInformation']/*[namespace-uri()=$ns1 and local-name()='foreignFunding']"/>
      ...
      <table cardinality="oto" sqlname="contractMarketingData">
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractMarketingData']/*[namespace-uri()=$ns1 and local-name()='websiteURL']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractMarketingData']/*[namespace-uri()=$ns1 and local-name()='whoCanUse']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">NUMERIC</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractMarketingData']/*[namespace-uri()=$ns1 and local-name()='individualOrderLimit']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractMarketingData']/*[namespace-uri()=$ns1 and local-name()='typeOfFeeForUseOfService']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">NUMERIC</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractMarketingData']/*[namespace-uri()=$ns1 and local-name()='fixedFeeValue']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">NUMERIC</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractMarketingData']/*[namespace-uri()=$ns1 and local-name()='feeRangeLowerValue']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">NUMERIC</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractMarketingData']/*[namespace-uri()=$ns1 and local-name()='feeRangeUpperValue']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractMarketingData']/*[namespace-uri()=$ns1 and local-name()='orderingProcedure']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">NUMERIC</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractMarketingData']/*[namespace-uri()=$ns1 and local-name()='feePaidForUseOfService']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractMarketingData']/*[namespace-uri()=$ns1 and local-name()='emailAddress']"/>
      ...
      <table cardinality="oto" sqlname="contractInformation">
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='typeOfContractPricing']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='undefinitizedAction']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='multiYearContract']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='typeOfIDC']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='multipleOrSingleAwardIDC']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='performanceBasedServiceContract']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(100)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='majorProgramCode']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='contingencyHumanitarianPeacekeepingOperation']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='costOrPricingData']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='contractFinancing']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='costAccountingStandardsClause']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='descriptionOfContractRequirement']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='purchaseCardAsPaymentMethod']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">INTEGER</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='numberOfActions']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='nationalInterestActionCode']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(1000)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='inherentlyGovernmentalFunction']"/>
          <!-- /ns1:award/ns1:contractData/ns1:inherentlyGovernmentalFunction -->
        </column>
      </table>
      <xsl:for-each select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='listOfTreasuryAccounts']/*[namespace-uri()=$ns1 and local-name()='treasuryAccount']">
      ...
      <table cardinality="oto" sqlname="legislativeMandates">
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='legislativeMandates']/*[namespace-uri()=$ns1 and local-name()='ClingerCohenAct']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='legislativeMandates']/*[namespace-uri()=$ns1 and (local-name()='materialsSuppliesArticlesEquipment' or local-name()='WalshHealyAct')]"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='legislativeMandates']/*[namespace-uri()=$ns1 and (local-name()='laborStandards' or local-name()='serviceContractAct')]"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>          
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='legislativeMandates']/*[namespace-uri()=$ns1 and (local-name()='constructionWageRateRequirements' or local-name()='DavisBaconAct')]"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='legislativeMandates']/*[namespace-uri()=$ns1 and local-name()='interagencyContractingAuthority']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(1000)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='legislativeMandates']/*[namespace-uri()=$ns1 and local-name()='otherStatutoryAuthority']"/>
          <!-- /ns1:award/ns1:legislativeMandates/ns1:otherStatutoryAuthority -->
        </column>
      </table>
      <xsl:for-each select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='legislativeMandates']/*[namespace-uri()=$ns1 and local-name()='listOfAdditionalReportingValues']/*[namespace-uri()=$ns1 and local-name()='additionalReportingValue']">
      ...
      <table cardinality="oto" sqlname="productOrServiceInformation">
        <column>
          ...
          <xsl:attribute name="datatype">CHAR(4)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='productOrServiceCode']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='systemEquipmentCode']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(100)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='productOrServiceCode']/@description"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(3)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='claimantProgramCode']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='principalNAICSCode']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='informationTechnologyCommercialItemCategory']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='GFE-GFP']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='useOfEPADesignatedProducts']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='recoveredMaterialClauses']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='seaTransportation']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='contractBundling']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='consolidatedContract']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='manufacturingOrganizationType']"/>
      ...
      <table cardinality="oto" sqlname="contractorDataA">
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorDUNSInformation']/*[namespace-uri()=$ns1 and local-name()='DUNSNumber']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(1000)</xsl:attribute>
          <xsl:variable name="locationcode" select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='placeOfPerformance']/*[namespace-uri()=$ns1 and local-name()='principalPlaceOfPerformance']/*[namespace-uri()=$ns1 and local-name()='locationCode']"/>
          <xsl:variable name="statecode" select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='placeOfPerformance']/*[namespace-uri()=$ns1 and local-name()='principalPlaceOfPerformance']/*[namespace-uri()=$ns1 and local-name()='stateCode']"/>
          <xsl:variable name="countrycode" select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='placeOfPerformance']/*[namespace-uri()=$ns1 and local-name()='principalPlaceOfPerformance']/*[namespace-uri()=$ns1 and local-name()='countryCode']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(100)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='placeOfPerformance']/*[namespace-uri()=$ns1 and local-name()='placeOfPerformanceName']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(3)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='countryOfOrigin']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(2)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLocation']/*[namespace-uri()=$ns1 and local-name()='congressionalDistrictCode']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(2)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='placeOfPerformance']/*[namespace-uri()=$ns1 and local-name()='placeOfPerformanceCongressionalDistrict']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='productOrServiceInformation']/*[namespace-uri()=$ns1 and local-name()='placeOfManufacture']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='CCRException']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(10)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='placeOfPerformance']/*[namespace-uri()=$ns1 and local-name()='placeOfPerformanceZIPCode']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorDUNSInformation']/*[namespace-uri()=$ns1 and local-name()='cageCode']"/>
      ...
      <table cardinality="oto" sqlname="competitionInformation">
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(3)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='extentCompeted']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(3)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='reasonNotCompeted']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">INTEGER</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='numberOfOffersReceived']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='commercialItemAcquisitionProcedures']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='commercialItemTestProgram']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='A76Action']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(5)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='solicitationProcedures']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(10)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='typeOfSetAside']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(6)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='evaluatedPreference']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='research']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(4)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='statutoryExceptionToFairOpportunity']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='fedBizOpps']"/>
      ...
      <table cardinality="oto" sqlname="preferencePrograms">
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='contractingOfficerBusinessSizeDetermination']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='preferencePrograms']/*[namespace-uri()=$ns1 and local-name()='subcontractPlan']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">NUMERIC</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='competition']/*[namespace-uri()=$ns1 and local-name()='priceEvaluationPercentDifference']"/>
      ...
      <table cardinality="oto" sqlname="transactionInformation">
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='contractActionType']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">CHARACTER(1)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='contractData']/*[namespace-uri()=$ns1 and local-name()='reasonForModification']"/>
      ...
      <table cardinality="oto" sqlname="contractorDataB">
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorBusinessTypes']/*[namespace-uri()=$ns1 and local-name()='isStateGovernment']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorBusinessTypes']/*[namespace-uri()=$ns1 and local-name()='isTribalGovernment']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorBusinessTypes']/*[namespace-uri()=$ns1 and local-name()='isForeignGovernment']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorBusinessTypes']/*[namespace-uri()=$ns1 and local-name()='isCommunityDevelopedCorporationOwnedFirm']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorBusinessTypes']/*[namespace-uri()=$ns1 and local-name()='isLaborSurplusAreaFirm']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorSocioEconomicIndicators']/*[namespace-uri()=$ns1 and local-name()='isVerySmallBusiness']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorCertifications']/*[namespace-uri()=$ns1 and local-name()='isSBACertified8AProgramParticipant']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorCertifications']/*[namespace-uri()=$ns1 and local-name()='isSBACertified8AJointVenture']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorCertifications']/*[namespace-uri()=$ns1 and local-name()='isDOTCertifiedDisadvantagedBusinessEnterprise']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorCertifications']/*[namespace-uri()=$ns1 and local-name()='isSelfCertifiedSmallDisadvantagedBusiness']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorCertifications']/*[namespace-uri()=$ns1 and local-name()='isSBACertifiedHUBZone']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorCertifications']/*[namespace-uri()=$ns1 and local-name()='isSBACertifiedSmallDisadvantagedBusiness']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorOrganizationFactors']/*[namespace-uri()=$ns1 and local-name()='isShelteredWorkshop']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfEducationalEntity']/*[namespace-uri()=$ns1 and local-name()='isHistoricallyBlackCollegeOrUniversity']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfEducationalEntity']/*[namespace-uri()=$ns1 and local-name()='is1862LandGrantCollege']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfEducationalEntity']/*[namespace-uri()=$ns1 and local-name()='is1890LandGrantCollege']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfEducationalEntity']/*[namespace-uri()=$ns1 and local-name()='is1994LandGrantCollege']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfEducationalEntity']/*[namespace-uri()=$ns1 and local-name()='isMinorityInstitution']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfEducationalEntity']/*[namespace-uri()=$ns1 and local-name()='isPrivateUniversityOrCollege']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfEducationalEntity']/*[namespace-uri()=$ns1 and local-name()='isSchoolOfForestry']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfEducationalEntity']/*[namespace-uri()=$ns1 and local-name()='isTribalCollege']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfEducationalEntity']/*[namespace-uri()=$ns1 and local-name()='isVeterinaryCollege']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLineOfBusiness']/*[namespace-uri()=$ns1 and local-name()='isEducationalInstitution']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfEducationalEntity']/*[namespace-uri()=$ns1 and local-name()='isAlaskanNativeServicingInstitution']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLineOfBusiness']/*[namespace-uri()=$ns1 and local-name()='isCommunityDevelopmentCorporation']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfEducationalEntity']/*[namespace-uri()=$ns1 and local-name()='isNativeHawaiianServicingInstitution']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLineOfBusiness']/*[namespace-uri()=$ns1 and local-name()='isDomesticShelter']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLineOfBusiness']/*[namespace-uri()=$ns1 and local-name()='isManufacturerOfGoods']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLineOfBusiness']/*[namespace-uri()=$ns1 and local-name()='isHospital']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLineOfBusiness']/*[namespace-uri()=$ns1 and local-name()='isVeterinaryHospital']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLineOfBusiness']/*[namespace-uri()=$ns1 and local-name()='isHispanicServicingInstitution']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLineOfBusiness']/*[namespace-uri()=$ns1 and local-name()='isFoundation']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorSocioEconomicIndicators']/*[namespace-uri()=$ns1 and local-name()='isWomenOwned']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorSocioEconomicIndicators']/*[namespace-uri()=$ns1 and local-name()='isWomenOwnedSmallBusiness']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorSocioEconomicIndicators']/*[namespace-uri()=$ns1 and local-name()='isVeteranOwned']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorRelationshipWithFederalGovernment']/*[namespace-uri()=$ns1 and local-name()='receivesContracts']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorRelationshipWithFederalGovernment']/*[namespace-uri()=$ns1 and local-name()='receivesGrants']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorRelationshipWithFederalGovernment']/*[namespace-uri()=$ns1 and local-name()='receivesContractsAndGrants']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfGovernmentEntity']/*[namespace-uri()=$ns1 and local-name()='isAirportAuthority']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfGovernmentEntity']/*[namespace-uri()=$ns1 and local-name()='isCouncilOfGovernments']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfGovernmentEntity']/*[namespace-uri()=$ns1 and local-name()='isHousingAuthoritiesPublicOrTribal']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfGovernmentEntity']/*[namespace-uri()=$ns1 and local-name()='isInterstateEntity']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfGovernmentEntity']/*[namespace-uri()=$ns1 and local-name()='isPlanningCommission']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfGovernmentEntity']/*[namespace-uri()=$ns1 and local-name()='isPortAuthority']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='typeOfGovernmentEntity']/*[namespace-uri()=$ns1 and local-name()='isTransitAuthority']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorOrganizationFactors']/*[namespace-uri()=$ns1 and local-name()='isSubchapterSCorporation']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorOrganizationFactors']/*[namespace-uri()=$ns1 and local-name()='isLimitedLiabilityCorporation']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorOrganizationFactors']/*[namespace-uri()=$ns1 and local-name()='isForeignOwnedAndLocated']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorSocioEconomicIndicators']/*[namespace-uri()=$ns1 and local-name()='isAmericanIndianOwned']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorSocioEconomicIndicators']/*[namespace-uri()=$ns1 and local-name()='isIndianTribe']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">BOOLEAN</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorSocioEconomicIndicators']/*[namespace-uri()=$ns1 and local-name()='isTriballyOwnedFirm']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(400)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorHeader']/*[namespace-uri()=$ns1 and local-name()='vendorDoingAsBusinessName']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLocation']/*[namespace-uri()=$ns1 and local-name()='streetAddress']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(150)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLocation']/*[namespace-uri()=$ns1 and local-name()='streetAddress2']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(150)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLocation']/*[namespace-uri()=$ns1 and local-name()='streetAddress3']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLocation']/*[namespace-uri()=$ns1 and local-name()='city']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLocation']/*[namespace-uri()=$ns1 and local-name()='state']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(50)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLocation']/*[namespace-uri()=$ns1 and local-name()='ZIPCode']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(3)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLocation']/*[namespace-uri()=$ns1 and local-name()='countryCode']"/>
        ...
        <column>
          ...
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLocation']/*[namespace-uri()=$ns1 and local-name()='phoneNo']"/>
        ...
        <column>
          ...
          <xsl:attribute name="datatype">VARCHAR(30)</xsl:attribute>
          <xsl:value-of select="/*[namespace-uri()=$ns1 and (local-name()='award' or local-name()='IDV')]/*[namespace-uri()=$ns1 and local-name()='vendor']/*[namespace-uri()=$ns1 and local-name()='vendorSiteDetails']/*[namespace-uri()=$ns1 and local-name()='vendorLocation']/*[namespace-uri()=$ns1 and local-name()='faxNo']"/>
